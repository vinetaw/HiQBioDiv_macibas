...
MVR_dati <- st_read_parquet("C:/Users/vinet/Documents/VPP/2uzd/apv_centra.parquet", quiet = TRUE)

#Kartes lapu lejupielāde un ielase
kartes_url <- "https://zenodo.org/records/14277114/files/tks93_50km.parquet?download=1"
curl_download(kartes_url, "C:/Users/vinet/Documents/VPP/5uzd/karte.parquet")
...
kartes <- st_read_parquet("C:/Users/vinet/Documents/VPP/5uzd/karte.parquet", quiet = TRUE)
...
#kartes <- kartes %>%
#  filter(kartes$NUMURS == c(3244, 3333, 3331, 3242))
